package ir.artshoppingart.repository;

import ir.artshoppingart.ArtShoppingCartApp;
import ir.artshoppingart.config.Constants;
import ir.artshoppingart.config.TestSecurityConfiguration;
import ir.artshoppingart.config.audit.AuditEventConverter;
import ir.artshoppingart.domain.PersistentAuditEvent;
...
import static ir.artshoppingart.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
